...
export default function Page() {
  return (
    <div>
      <Header
        paragraph="Você vai descobrir tudo que precisa ter acesso para faturar alto em um ambiente jurídico de constante evolução."
      >
        <h1 className="text-zambo sm:text-4xl text-2xl font-thin">Conheça a <strong className="font-semibold">primeira pós-graduação no Brasil</strong> que prepara <strong className="font-semibold">advogados criminalistas para tendências do futuro.</strong></h1>
      </Header>
      <main className="">
