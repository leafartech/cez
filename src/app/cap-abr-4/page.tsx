...
export default function Page() {
  return (
    <div>
      ...
      >
        <h1 className="text-zambo sm:text-4xl text-2xl font-thin">Participe do lançamento da <strong className="font-semibold">advogados criminalistas</strong> que prepara advogados criminalistas para as <strong className="font-semibold">tendências do futuro</strong>.</h1>
      </Header>
      <main className="">
