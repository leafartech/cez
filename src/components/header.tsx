...
export default function Header({ paragraph, children, top }: HeaderProps) {
    let cont = 0
    useEffect(() => {
        if (cont === 0) {
    ...
    return (
        <header className={`relative px-4 radial sm:h-screen w-full flex flex-col-reverse justify-center items-center ${top ? 'sm:pt-32 pt-12' : 'sm:pt-20'}`}>
